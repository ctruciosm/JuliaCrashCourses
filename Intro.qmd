...
[Repositório da Aula](https://github.com/Arthur-Dionizio/minicurso-julia)
:::
...
> Acessem o link [https://tidierorg.github.io/Tidier.jl/v1.6.1/](https://tidierorg.github.io/Tidier.jl/v1.6.1/) para mais informações!
...
# Selecionar e limpar
numdf = select(dados, var_numericas)
...
X = select(dados, union(var_numericas, var_categoricas))
y = dados.energy
```
...
-   Documentação oficial da biblioteca Tidier.jl [https://tidierorg.github.io/Tidier.jl/v1.6.1/](https://tidierorg.github.io/Tidier.jl/v1.6.1/)
